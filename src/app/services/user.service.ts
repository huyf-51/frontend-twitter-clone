...
export class UserService {
  ...
  getUser(username: string): Observable<UserInformation> {
    let url = `${environment.apiEndPoint}/api/users/` + username;
    return this.http
      .get(url)
      .pipe(
  ...
  putBannerPic(file: any, id: number) {
    let url = `${environment.apiEndPoint}/api/users/` + id + '/banner-image';
    ...
    return this.http
      ...
      .pipe(catchError((error) => this.handleError(error))) as any;
  }

  putProfilePic(file: any, id: number) {
    let url = `${environment.apiEndPoint}/api/users/` + id + '/user-image';
    let formData = new FormData();
    formData.append('file', file, file.name);
    let headers = new HttpHeaders();
    headers.append('Content-Type', 'multipart/form-data');
  ...
  putNickname(nickname: string, id: number) {
    let url = `${environment.apiEndPoint}/api/users/` + id + '/nickname';
    return this.http
  ...
  putBiography(biography: string, id: number) {
    let url = `${environment.apiEndPoint}/api/users/` + id + '/biography';
    return this.http
  ...
  getStatistics(): Observable<object> {
    let url = `${environment.apiEndPoint}/api/users/statistics`;
    return this.http
      .get(url)
      .pipe(
        catchError((error) => this.handleError(error))
  ...
  getUsersToVerify(): Observable<UserInformation[]> {
    let url = `${environment.apiEndPoint}/api/users-to-verify`;
    return this.http
      .get(url)
      .pipe(catchError((error) => this.handleError(error))) as Observable<
      UserInformation[]
  ...
  getVerificatedUsers(): Observable<UserInformation[]> {
    let url = `${environment.apiEndPoint}/api/verificated-users`;
    return this.http
      .get(url)
      .pipe(catchError((error) => this.handleError(error))) as Observable<
      UserInformation[]
  ...
  getBannedUsers(): Observable<UserInformation[]> {
    let url = `${environment.apiEndPoint}/api/banned-users`;
    return this.http
      .get(url)
      .pipe(catchError((error) => this.handleError(error))) as Observable<
      UserInformation[]
  ...
  verifyUser(id: number) {
    let url = `${environment.apiEndPoint}/api/users/` + id + '?type=VERIFY';
    return this.http
      .put(url, null)
      .pipe(catchError((error) => this.handleError(error)));
  }
  ...
  unverifyUser(id: number) {
    let url = `${environment.apiEndPoint}/api/users/` + id + '?type=UNVERIFY';
    return this.http
      .put(url, null)
      .pipe(catchError((error) => this.handleError(error)));
  }
  ...
  banUser(id: number) {
    let url = `${environment.apiEndPoint}/api/users/` + id + '?type=BAN';
    return this.http
      .put(url, null)
      .pipe(catchError((error) => this.handleError(error)));
  }
  ...
  unbannedUser(id: number) {
    let url = `${environment.apiEndPoint}/api/users/` + id + '?type=UNBAN';
    return this.http
      .put(url, null)
      .pipe(catchError((error) => this.handleError(error)));
  }
  ...
  toggleFollow(id: number) {
    let url = `${environment.apiEndPoint}/api/users/` + id + '/followers';
    return this.http
      .put(url, null)
      .pipe(catchError((error) => this.handleError(error)));
  }
  ...
  getRecommendedUsers(): Observable<UserInformation[]> {
    let url = `${environment.apiEndPoint}/api/recommended-users`;
    return this.http
      .get(url)
      .pipe(catchError((error) => this.handleError(error))) as Observable<
      UserInformation[]
